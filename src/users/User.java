...
public abstract class User implements Serializable{
     ...
     */
    public Boolean validateCredentials(String nif, String pwd) {
     ...
     * @return true if the name is changed successfully, false otherwise
     */
    public boolean changeName(String newName) {
        if (newName.length() > 1 || this == ArtGallery.getSystem().getLoggedUser()) {
            this.name = newName;
            return true;
        }
     ...
     * @return true if the surname is changed successfully, false otherwise
     */
    public boolean changeSurname(String newSurname) {
        if (newSurname.length() > 1 || this == ArtGallery.getSystem().getLoggedUser()) {
