...
public class InventoryTests {
    ...
    public void testSendReparation() {
        ...
        assertEquals(Status.RESTORATION, workToRepair.getStatus());
    }
    ...
    public void testSetWorks() {
        ...
        newWorks.add(new Painting("Nueva Obra 1", "Nuevo Autor 1", false, 10, 5.0, 15.0, 3.0, 25.0, "Tecnica 1"));
        newWorks.add(new Photo("Nueva Obra 2", "Nuevo Autor 2", true, 0, 8.0, 18.0, 4.0, 30.0, true, "Formato 2", 0));
