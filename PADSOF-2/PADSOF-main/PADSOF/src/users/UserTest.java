...
class UserTest {
	...
	void testHasPrivilege() {
		//Admin
		admin.addPrivilege(Privileges.TEMPERATURA);
		assertTrue(admin.hasPrivilege(Privileges.TEMPERATURA));
		//Staff
		staff.addPrivilege(Privileges.TEMPERATURA);
		assertTrue(staff.hasPrivilege(Privileges.TEMPERATURA));
		//Client
		client.addPrivilege(Privileges.TEMPERATURA);
		assertTrue(client.hasPrivilege(Privileges.TEMPERATURA));
	}
	...
	void testAddPrivilege() {
		//Admin
		admin.addPrivilege(Privileges.TEMPERATURA);
		assertTrue(admin.privileges.contains(Privileges.TEMPERATURA));
		//Staff
		staff.addPrivilege(Privileges.TEMPERATURA);
		assertTrue(staff.privileges.contains(Privileges.TEMPERATURA));
		//Client
		client.addPrivilege(Privileges.TEMPERATURA);
		assertTrue(client.privileges.contains(Privileges.TEMPERATURA));
	}
